...
export default function BaseOptionChart() {
  ...
  return {
    ...
    stroke: {
      width: 3,
      curve: "smooth" as "smooth" | "straight" | "stepline" | ("smooth" | "straight" | "stepline")[] | undefined,
    ...
    legend: {
      show: true,
      fontSize: "13px" as string | undefined,
      position: "top" as "top" | "right" | "bottom" | "left" | undefined,
      horizontalAlign: "right" as "left" | "right" | "center" | undefined,
      markers: { radius: 12 },
    ...
    plotOptions: {
      ...
      radar: {
        polygons: {
          strokeWidth: "1px" as string | string[] | undefined,
